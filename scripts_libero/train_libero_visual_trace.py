...
from iclr.data.dataset_libero_visual_trace import SequenceDataset_Libero_Visual_Trace
...
from iclr.util.engine_libero import train_one_epoch_libero_visual_trace
...
def main(args : ExperimentConfig):
    ...
    dataset_train = SequenceDataset_Libero_Visual_Trace(
    ...
    dataset_val = SequenceDataset_Libero_Visual_Trace(
        dataset_config=args.dataset_cfg,
        shared_config=args.shared_cfg,
        vision_transform=vision_transform,
        no_aug_vision_transform=no_aug_vision_transform,
    ...
    for epoch in range(args.shared_cfg.start_epoch, args.trainer_cfg.epochs):
        ...
        train_stats = train_one_epoch_libero_visual_trace(  # main function of training
        ...
        if data_loader_val is not None:
            with torch.no_grad():
                val_stats = train_one_epoch_libero_visual_trace(
