...
from iclr.models.policy_real import ICLR_Real
...
def policy_constructor_real_visual_trace(
...
def model_constructor_real_visual_trace(
    model_config : ModelConfig, 
    shared_config : SharedConfig,
    train : bool = True, 
) -> ICLR_Real:
    vision_encoder = vision_encoder_constructor(model_config.vision_encoder_cfg)
    policy = policy_constructor_real_visual_trace(model_config.policy_cfg, shared_config, vision_encoder, train=train)
    return policy