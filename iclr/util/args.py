...
class DatasetConfig: 
    ...
    # variance of the noise added to visual trace 
    visual_trace_noise : float = 0.005
...
@dataclasses.dataclass
class VisionEncoderConfig:  # currently use a pretrained vision encoder and freeze it during training
...
class SharedConfig:
    ...
    # NEW: number of visual trace points
