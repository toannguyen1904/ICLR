...
from iclr.util.args import ModelConfig, SharedConfig, VisionEncoderConfig, PolicyConfig
from iclr.models.backbones.encoders import VisionEncoder, VisionEncoderCNN
from iclr.models.policy_libero import ICLR_Libero
...
def policy_constructor_libero_visual_trace(
    ...
    proprio_dim = 11 if shared_config.rot_6d else 9
    ...
    model = ICLR_Libero(
        ...
        num_visual_trace_points=shared_config.num_visual_trace_points,
...
def model_constructor_libero_visual_trace(
    model_config : ModelConfig, 
    shared_config : SharedConfig,
    train : bool = True, 
) -> ICLR_Libero:
    vision_encoder = vision_encoder_constructor(model_config.vision_encoder_cfg)
    policy = policy_constructor_libero_visual_trace(model_config.policy_cfg, shared_config, vision_encoder, train=train)
    return policy